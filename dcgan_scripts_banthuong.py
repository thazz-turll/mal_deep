...
# Model save paths
GEN_SAVE_PATH = "generator_mal-dcgan_BASE.pt"
SUB_SAVE_PATH = "substitute_detector_dcgan_BASE.pt"
...
class Generator(nn.Module):
    ...
    def forward(self, real_x, z):
        ...
        # Trong code cơ sở này, chúng ta không dùng perturb_mask_scaled trong hàm loss
...
# ================== Training loop (ĐÃ SỬA VỀ MÔ HÌNH CƠ SỞ) ==================
print("Start training Mal-DCGAN [BASE] procedure...")
